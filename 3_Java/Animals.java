...
public class Animals {
    ...
    protected Animals(String name, LocalDate birthday, TypeAnimal type) {
        this.name = name;
    ...
    protected Animals(String name, LocalDate birthday, Set<String> commands, TypeAnimal type) {
        this.name = name;
        this.birthday = birthday;
    ...
    public static Animals parse(CharSequence input) throws RuntimeException {
